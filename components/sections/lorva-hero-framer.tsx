  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y: scrollY }}>
        ...
        >
          {/* Perspective container for 3D tilt + spin */}
          <div style={{ perspective: '900px', perspectiveOrigin: 'center center' }}>

            {/* Continuous slow Y-axis turntable spin — each photo at a different speed */}
            <motion.div
              animate={{ rotateY: [0, 360] }}
              transition={{
                duration: photo.floatDuration * 1.85,
                repeat: Infinity,
                ease: 'linear',
              }}
            ...
            <motion.div
              animate={{
                ...
                opacity: (anyClicked && !isClicked)
                  ...
                  ? 0.28
                  : 1,
                // X-axis tilt on hover (cursor-tracked) — Y handled by spin wrapper
