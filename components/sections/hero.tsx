  ...
  return (
    ...
    >
      ...
      <div className="hero-content relative z-10 w-full flex items-center pl-5 lg:pl-[100px] pr-5 pt-28 md:pt-0 pb-24">
        ...
        <div className="absolute -bottom-[190px] right-[8%] z-10 md:relative md:bottom-auto md:right-auto md:z-auto md:flex-1 md:flex md:items-center md:justify-center">
          <FlavorShowcase />
        </div>
      </div>
    </section>
